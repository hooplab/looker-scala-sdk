...
case class SamlConfig (
  ...
  groups: Option[List[SamlGroupRead]] = None,
  // (Read/Write) Array of mappings between Saml Groups and arrays of Looker Role ids
  groupsWithRoleIds: Option[List[SamlGroupWrite]] = None,
  ...
  userAttributes: Option[List[SamlUserAttributeRead]] = None,
  // (Read/Write) Array of mappings between Saml User Attributes and arrays of Looker User Attribute ids
  userAttributesWithIds: Option[List[SamlUserAttributeWrite]] = None,
