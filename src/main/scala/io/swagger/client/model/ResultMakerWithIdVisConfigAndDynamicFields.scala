...
case class ResultMakerWithIdVisConfigAndDynamicFields (
  // Unique Id.
  id: Option[Long] = None,
  // JSON string of dynamic field information.
  dynamicFields: Option[String] = None,
  // array of items that can be filtered and information about them.
  filterables: Option[List[ResultMakerFilterables]] = None,
