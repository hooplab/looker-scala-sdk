...
case class LookmlModel (
  ...
  allowedDbConnectionNames: Option[List[String]] = None,
  // Is this model allowed to use all current and future connections
  unlimitedDbConnections: Option[Boolean] = None,
  ...
  explores: Option[List[LookmlModelNavExplore]] = None,
