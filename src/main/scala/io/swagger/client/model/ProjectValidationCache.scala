...
case class ProjectValidationCache (
  // A list of project errors
  errors: Option[List[ProjectError]] = None,
  // A hash value computed from the project's current state
  projectDigest: Option[String] = None,
  // A list of models which were not fully validated
  modelsNotValidated: Option[List[ModelsNotValidated]] = None,
