...
case class WhitelabelConfiguration (
  // Unique Id
  id: Option[Long] = None,
  ...
  faviconFile: Option[String] = None,
  ...
  showHelpMenu: Option[Boolean] = None,
  // Boolean to toggle showing docs
  showDocs: Option[Boolean] = None,
  // Boolean to toggle showing email subscription options.
  showEmailSubOptions: Option[Boolean] = None,
  // Boolean to toggle mentions of Looker in emails
  allowLookerMentions: Option[Boolean] = None,
  // Boolean to toggle links to Looker in emails
  allowLookerLinks: Option[Boolean] = None,
